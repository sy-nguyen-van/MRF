...
%% Boundary conditions
    ...
    FE.mesh_input.bcs_file = 'input_files/Lbracket2d/MRF/h2_B12_LKS_r25/setup_bcs_Lbracket2d.m';
...
% functions:
    ...
    OPT.functions.constraints = {'maximum stress violation'};  % maximum stress violation 
    ...
    OPT.functions.constraint_scale = [20];
    OPT.parameters.slimit = [3.0];
%% =======================================================================        
...
%   Required: aggregation_type = 'p-norm'
%             aggregation_function = 'p-norm', continuation = false;
    % Relaxation power 
    OPT.parameters.aggregation_parameter = 8;
    % Type of aggregation function. Options: 'p-norm'
    OPT.parameters.aggregation_type = 'p-norm';

%% =======================================================================        
%% Density for initial design
    OPT.parameters.init_dens = 0.1;
%% =======================================================================        
%% Optimization parameters
    ...
    OPT.options.vtk_output_path = 'output_files/Lbracket2d/MRF/h2_B12_LKS_r25/';
    % Path to write .mat file with densities for current design
    OPT.options.mat_output_path = 'output_files/Lbracket2d/MRF/h2_B12_LKS_r25/';
    % Path to save files if requested
    OPT.options.outputs_path = strcat('output_files/Lbracket2d/MRF/h2_B12_LKS_r25/');    
