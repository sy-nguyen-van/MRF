...
%% Boundary conditions
    ...
    FE.mesh_input.bcs_file = 'input_files/cantilever3d/ACS/setup_bcs_cantilever3d.m';
...
%% Optimization parameters
    ...
    OPT.options.vtk_output_path = 'output_files/cantilever3d/ACS/';
    % Path to write .mat file with densities for current design
    OPT.options.mat_output_path = 'output_files/cantilever3d/ACS/';
    % Path to save files if requested
    OPT.options.outputs_path = 'output_files/cantilever3d/ACS/';
