...
%% Boundary conditions
    ...
    FE.mesh_input.bcs_file = 'input_files/cantilever3d/COMP/setup_bcs_cantilever3d.m';
...
% functions:
    ...
    OPT.functions.objective_scale = 0.1;
    ...
    OPT.functions.constraint_limit = [0.3197]; % ***
...
%% Penalization and filtering parameters 
    ...
    OPT.parameters.filter_radius_factor = 2;
...
%
    ...
    OPT.parameters.rectifier_parameter_init = 12;
    OPT.parameters.rectifier_parameter = 32;
    OPT.parameters.rectifier_parameter_delta = 0.4;
