...
%% Boundary conditions
    ...
    FE.mesh_input.bcs_file = 'input_files/Vframe2d/COMP/setup_bcs_Vframe2d.m';
...
% functions:
    ...
    OPT.functions.objective_scale = 0.01;
    ...
    OPT.functions.constraint_limit = [0.213]; % ***
...
%% Optimization parameters
    ...
    OPT.options.vtk_output_path = 'output_files/Vframe2d/COMP/';
    % Path to write .mat file with densities for current design
    OPT.options.mat_output_path = 'output_files/Vframe2d/COMP/';
    % Path to save files if requested
    OPT.options.outputs_path = strcat('output_files/Vframe2d/COMP/');    
