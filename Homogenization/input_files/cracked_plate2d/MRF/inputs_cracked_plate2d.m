...
%% Boundary conditions
    ...
    FE.mesh_input.bcs_file = 'input_files/cracked_plate2d/MRF/setup_bcs_cracked_plate2d.m';
...
%% Optimization parameters
    ...
    OPT.options.vtk_output_path = 'output_files/cracked_plate2d/MRF/';
    % Path to write .mat file with densities for current design
    OPT.options.mat_output_path = 'output_files/cracked_plate2d/MRF/';
    % Path to save files if requested
    OPT.options.outputs_path = strcat('output_files/cracked_plate2d/MRF/');    
