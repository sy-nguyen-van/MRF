...
%% Boundary conditions
    ...
    FE.mesh_input.bcs_file = 'input_files/Lbracket2d/MRF/h05_B12_LKS_r25/setup_bcs_Lbracket2d.m';
...
%% Optimization parameters
    ...
    OPT.options.vtk_output_path = 'output_files/Lbracket2d/MRF/h05_B12_LKS_r25/';
    % Path to write .mat file with densities for current design
    OPT.options.mat_output_path = 'output_files/Lbracket2d/MRF/h05_B12_LKS_r25/';
    % Path to save files if requested
    OPT.options.outputs_path = strcat('output_files/Lbracket2d/MRF/h05_B12_LKS_r25/');    
