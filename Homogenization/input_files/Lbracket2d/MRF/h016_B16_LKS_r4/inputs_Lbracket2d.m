...
FE.mesh_input.L_element_size = 0.16;
...
%% Boundary conditions
    ...
    FE.mesh_input.bcs_file = 'input_files/Lbracket2d/MRF/h016_B12_LKS_r4/setup_bcs_Lbracket2d.m';
...
%% Penalization and filtering parameters 
    ...
    OPT.parameters.filter_radius_factor = 4;
...
%
    ...
    OPT.parameter.cont_start_GRF = 0.9; % GRF value that triggers start of continuation
...
%% Optimization parameters
    ...
    OPT.options.vtk_output_path = 'output_files/Lbracket2d/MRF/h016_B16_LKS_r4/';
    % Path to write .mat file with densities for current design
    OPT.options.mat_output_path = 'output_files/Lbracket2d/MRF/h016_B16_LKS_r4/';
    % Path to save files if requested
    OPT.options.outputs_path = 'output_files/Lbracket2d/MRF/h016_B16_LKS_r4/';
