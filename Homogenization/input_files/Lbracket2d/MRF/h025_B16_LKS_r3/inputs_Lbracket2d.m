...
FE.mesh_input.L_element_size = 0.25;
...
%% Boundary conditions
    ...
    FE.mesh_input.bcs_file = 'input_files/Lbracket2d/MRF/h025_B16_LKS_r3/setup_bcs_Lbracket2d.m';
...
%% Optimization parameters
    ...
    OPT.options.vtk_output_path = 'output_files/Lbracket2d/MRF/h025_B16_LKS_r3/';
    % Path to write .mat file with densities for current design
    OPT.options.mat_output_path = 'output_files/Lbracket2d/MRF/h025_B16_LKS_r3/';
    % Path to save files if requested
    OPT.options.outputs_path = strcat('output_files/Lbracket2d/MRF/h025_B16_LKS_r3/');    
