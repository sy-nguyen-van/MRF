function inputs_doubleLbracket2d()
%% Input file 
%
...
%                  dimensions 
% 5- 'double2DLb': Generate a 2D double L-bracket mesh on the fly by
%                  providing the dimensions
% 

FE.mesh_input.type = 'double2DLb';
...
%
% FE.mesh_input.L_side = 160;
% FE.mesh_input.L_cutout = 60;
% FE.mesh_input.L_element_size = 1;

% If mesh input type is 'double2DLb', you must provide the dimensions of
% the width and height of the double L-shape, the length of the side of 
% the square cutouts on the top-left and top-right sides, and the element
% size.
%
FE.mesh_input.L_width = 160;
FE.mesh_input.L_height = 100;
FE.mesh_input.L_cutout = 60;
FE.mesh_input.L_element_size = 0.8;
...
%% Boundary conditions
    ...
    FE.mesh_input.bcs_file = 'input_files/doubleLbracket2d/MRF/setup_bcs_doubleLbracket2d.m';
...
%% Optimization parameters
    ...
    OPT.options.vtk_output_path = 'output_files/doubleLbracket2d/MRF/';
    % Path to write .mat file with densities for current design
    OPT.options.mat_output_path = 'output_files/doubleLbracket2d/MRF/';
    % Path to save files if requested
    OPT.options.outputs_path = strcat('output_files/doubleLbracket2d/MRF/');      
